...
class GeneralEffect(models.Model):
    key = models.AutoField(primary_key=True)
    general_effect_one_one = models.ForeignKey(
        RepPerfTotal, on_delete=models.CASCADE, related_name="general_effect_one_one"
    )
    general_effect_one_two = models.ForeignKey(
        RepPerfTotal,
        on_delete=models.CASCADE,
        related_name="general_effect_one_two",
        null=True,
    )
    general_effect_two_one = models.ForeignKey(
        RepPerfTotal, on_delete=models.CASCADE, related_name="general_effect_two_one"
    )
    general_effect_two_two = models.ForeignKey(
        RepPerfTotal,
        on_delete=models.CASCADE,
...
class Visual(models.Model):
    key = models.AutoField(primary_key=True)
    visual_proficiency = models.ForeignKey(
        ContAchvTotal, on_delete=models.CASCADE, related_name="visual_proficiency"
    )
    visual_analysis = models.ForeignKey(
        ContAchvTotal, on_delete=models.CASCADE, related_name="visual_analysis"
    )
    color_guard = models.ForeignKey(
        ContAchvTotal, on_delete=models.CASCADE, related_name="color_guard"
    )
...
class Music(models.Model):
    key = models.AutoField(primary_key=True)
    music_brass = models.ForeignKey(
        ContAchvTotal, on_delete=models.CASCADE, related_name="music_brass"
    )
    music_analysis_one = models.ForeignKey(
        ContAchvTotal, on_delete=models.CASCADE, related_name="music_analysis_one"
    )
    music_analysis_two = models.ForeignKey(
        ContAchvTotal,
        on_delete=models.CASCADE,
        related_name="music_analysis_two",
        null=True,
    )
    music_percussion = models.ForeignKey(
        ContAchvTotal, on_delete=models.CASCADE, related_name="music_percussion"
    )
...
class Show(models.Model):
    ...
    competition = models.ForeignKey(
        Competition, on_delete=models.RESTRICT, related_name="competition"
    )
    corp = models.ForeignKey(Corp, on_delete=models.RESTRICT, related_name="corp")
    general_effect = models.ForeignKey(
        GeneralEffect, on_delete=models.CASCADE, related_name="general_effect"
    )
